                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlcat_name" v-model.trim="formData.cat_name"  label="Cat Name" type="text" placeholder="Enter Cat Name"      
                                                    class="" :error="isFieldValid('cat_name')" :error-message="getFieldError('cat_name')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
